...
- (void)viewDidLoad {
    ...
    self.authShopLabel.text = NSLocalizedStringForKey(@"Fwdetsc 认证商家");
...
- (void)reqGetOrderDetailFinished:(id)result
{
    ...
    if([parser parseBaseIsOk:result]){
        ...
        _lbAmount.text = [NSString stringWithFormat:NSLocalizedStringForKey(@"您正在向Fwdetsc 认证卖家购买%@ USDT"), _model.amount];
