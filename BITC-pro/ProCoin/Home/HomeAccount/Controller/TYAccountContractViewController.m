//
//  TYAccountContractViewController.m
//  ProCoin
//
...
@interface TYAccountContractViewController ()<UITableViewDelegate, UITableViewDataSource>
...
@implementation TYAccountContractViewController
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.section == 0){
        ...
        if(self.tokenModel == nil)
            return cell;
        cell.indexModel = self.tokenModel;
