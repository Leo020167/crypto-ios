...
- (void)initUI{
    ...
    NSMutableArray *titlesArray = [NSMutableArray arrayWithArray:@[NSLocalizedStringForKey(@"余额"), NSLocalizedStringForKey(@"跟单账户"), NSLocalizedStringForKey(@"全球期指账户"), NSLocalizedStringForKey(@"合约账户"), NSLocalizedStringForKey(@"币币账户")]];
