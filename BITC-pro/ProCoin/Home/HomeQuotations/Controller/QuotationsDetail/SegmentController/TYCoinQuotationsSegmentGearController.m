...
@interface TYCoinQuotationsSegmentGearController ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation TYCoinQuotationsSegmentGearController
...
- (CGFloat)tradeDataCellHeight
{
    if(_tradeDataCellHeight == 0){
        _tradeDataCellHeight = [TYCoinQuotationsTradeDataCell coinQuotationTradeDataCellHeight];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    TYCoinQuotationsTradeDataCell *cell = [tableView dequeueReusableCellWithIdentifier:@"TYCoinQuotationsTradeDataCell"];
    if(cell == nil){
        cell = (TYCoinQuotationsTradeDataCell *)[[[NSBundle mainBundle] loadNibNamed:@"TYCoinQuotationsTradeDataCell" owner:nil options:nil] lastObject];
    }
