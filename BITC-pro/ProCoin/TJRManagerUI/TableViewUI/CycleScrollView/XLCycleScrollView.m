...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        rect.size.height = 30;
        pageControl = [[StyledPageControl alloc] initWithFrame:rect];
        pageControl.userInteractionEnabled = NO;
        [pageControl setPageControlStyle:PageControlStyleDefault];
        pageControl.coreNormalColor = [UIColor whiteColor];
        pageControl.coreSelectedColor = [UIColor colorWithRed:89.0f/255.0f green:184.0f/255.0f blue:228.0f/255.0f alpha:1];
...
- (void)loadData
{
    ...
    pageControl.currentPage = _curPage;
...
- (void)scrollViewWillBeginDragging:(UIScrollView *)scrollView{
    if (isSetTimer && [_delegate respondsToSelector:@selector(stopAutoScroll)]){
        [_delegate stopAutoScroll];
    }
}
- (void)scrollViewDidEndDragging:(UIScrollView *)scrollView willDecelerate:(BOOL)decelerate{
    if (isSetTimer && [_delegate respondsToSelector:@selector(beginAutoScroll)])
        [_delegate beginAutoScroll];
}
