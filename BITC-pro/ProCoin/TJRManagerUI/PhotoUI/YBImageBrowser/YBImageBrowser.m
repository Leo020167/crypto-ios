...
NSString *const YBImageBrowserRefreshNotification = @"YBImageBrowserRefreshNotification";
...
- (void)addNotification {
    ...
    // 接受外界传过来的通知进行刷新
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(reloadCollectionView) name:YBImageBrowserRefreshNotification object:nil];
}
...
- (void)initData {
    ...
    _inAnimation = YBImageBrowserAnimationFade;
    _outAnimation = YBImageBrowserAnimationFade;
