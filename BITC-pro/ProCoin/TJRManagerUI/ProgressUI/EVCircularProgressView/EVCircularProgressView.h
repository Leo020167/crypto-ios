...
typedef enum {
    EVCircularProgressBlackTint = 1UL << 0, // default
    EVCircularProgressWhiteTint = 1UL << 1,
    EVCircularProgressDefaultTint = EVCircularProgressBlackTint
} EVCircularProgressStyle;
...
@property (nonatomic) EVCircularProgressStyle style;

// Set the value of the progress property, optionally animating the change

@property (nonatomic, assign) BOOL isFooter; // 是否为加在尾部
