...
@interface RAEmailRegister ()<UITextFieldDelegate,TextFieldToolBarDelegate,RAJudgementDelegate>
{
    BOOL bReqFinished;
...
@implementation RAEmailRegister
...
- (void)viewDidLoad
{
    ...
    _textFieldRegisterAccount.placeholder = NSLocalizedStringForKey(@"邮箱");
...
//{
//    CountrySelectController *selectController = [[[CountrySelectController alloc] init] autorelease];
...
- (IBAction)registerphone_btn:(id)sender {
    [self goBack];
