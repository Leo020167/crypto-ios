...
NSString *const ApiBaseUrl        = @"http://api.adamfly.xyz/procoin/";   // 线上域名
NSString *const PushSocket        = @"api.adamfly.xyz";
NSString *const ApiQuoteUrl       = @"http://market.adamfly.xyz/procoin-market/";
NSString *const QuoteSocket       = @"market.adamfly.xyz";
NSString *const ApiFilesys        = @"http://upload.adamfly.xyz/procoin-file/";   // 上传文件接口
