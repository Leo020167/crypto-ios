...
NSString *const ApiBaseUrl        = @"http://api.shananan1.cn/procoin/";   // 线上域名
NSString *const PushSocket        = @"api.shananan1.cn";
NSString *const ApiQuoteUrl       = @"http://market.shananan1.cn/procoin-market/";
NSString *const QuoteSocket       = @"market.shananan1.cn";
NSString *const ApiFilesys        = @"http://upload.shananan1.cn/procoin-file/";   // 上传文件接口
