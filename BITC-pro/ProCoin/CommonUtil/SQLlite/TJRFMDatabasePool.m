...
#import "TJRFMDatabasePool.h"
#import "TJRFMDatabase.h"

@interface TJRFMDatabasePool()

- (void)pushDatabaseBackInPool:(TJRFMDatabase*)db;
- (TJRFMDatabase*)db;

@end


@implementation TJRFMDatabasePool
