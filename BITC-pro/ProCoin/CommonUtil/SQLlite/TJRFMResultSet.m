...
@implementation TJRFMResultSet
@synthesize query=_query;
@synthesize statement=_statement;

+ (instancetype)resultSetWithStatement:(TJRFMStatement *)statement usingParentDatabase:(TJRFMDatabase*)aDB {
    
    TJRFMResultSet *rs = [[TJRFMResultSet alloc] init];
...
- (void)setParentDB:(TJRFMDatabase *)newDb {
    _parentDB = newDb;
}
