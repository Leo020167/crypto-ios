//
//  PCStockFuturesRecordController.m
//  ProCoin
//
//  Created by Hay on 2020/2/24.
//  Copyright © 2020 Toka. All rights reserved.
//

#import "PCStockFuturesRecordController.h"
...
@interface PCStockFuturesRecordController ()<UITableViewDelegate,UITableViewDataSource,RZRefreshTableViewDelegate,UIScrollViewDelegate,PCDigitalRecordScreenViewDelegate>
{
...
@implementation PCStockFuturesRecordController
...
{
    [[NetWorkManage shareSingleNetWork] reqDigitalStockTransactionRecord:self symbol:@"" accountType:PCAccountStockType isDone:[NSString stringWithFormat:@"%@",@(PCTransactionDoneStateCurrentOrder)] pageNo:[NSString stringWithFormat:@"%@",@(orderPageNo)] buySell:@"" orderState:@"" type:@"" finishedCallback:@selector(reqTransactionOrderDataFinished:) failedCallback:@selector(reqTransactionOrderDataFailed:)];
}
...
{
    [[NetWorkManage shareSingleNetWork] reqDigitalStockTransactionRecord:self symbol:self.screenSymbol accountType:PCAccountStockType isDone:[NSString stringWithFormat:@"%@",@(PCTransactionDoneStateHistory)] pageNo:[NSString stringWithFormat:@"%@",@(historyPageNo)] buySell:@"" orderState:self.screenOrderType type:@"" finishedCallback:@selector(reqTransactionHistoryDataFinished:) failedCallback:@selector(reqTransactionHistoryDataFailed:)];
}
