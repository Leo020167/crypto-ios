//
//  PlatformAnnouncementViewController.m
//  ProCoin
//
//  Created by Luo Chun on 2024/1/19.
//  Copyright © 2024 Toka. All rights reserved.
//

#import "PlatformAnnouncementViewController.h"
...
@interface PlatformAnnouncementViewController ()<UITableViewDelegate,UITableViewDataSource,RZRefreshTableViewDelegate>
{
    NSInteger pageNo;
...
@implementation PlatformAnnouncementViewController

- (void)viewDidLoad
{
    [super viewDidLoad];
    
    self.titleLabel.text = NSLocalizedStringForKey(@"平台公告");
    pageNo = 1;
...
{
    [[NetWorkManage shareSingleNetWork] reqPlatformAnnouncementDataList:self pageNo:[NSString stringWithFormat:@"%@",@(pageNo)] finishedCallback:@selector(reqHelpDataFinished:) failedCallback:@selector(reqHttpRequestFailed:)];
}
